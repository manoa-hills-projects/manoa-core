...
export function AssistantSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="p-0 max-w-full w-full sm:max-w-md flex flex-col">
                  ...
                  {conversations
                    ...
                    .map((conv) => (
                      <div
                        key={conv.id}
                        className={cn(
                          "group flex w-full items-center gap-2 rounded-md px-2 py-2 text-left text-sm transition-colors hover:bg-accent cursor-pointer",
