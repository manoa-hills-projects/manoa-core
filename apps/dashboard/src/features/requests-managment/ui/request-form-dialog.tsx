        ...
        <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
            <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Completa los datos para generar tu solicitud. Será revisada por un administrador.
                    </DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-2">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Input
                            ...
                            {...register("fullName", { required: "Requerido", minLength: { value: 3, message: "Mínimo 3 caracteres" } })}
                        />
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Input
                            ...
                            max={100}
                            placeholder="Ej: 5"
                            {...register("yearsOfResidence", { required: "Requerido", min: { value: 0, message: "Mínimo 0" } })}
                        />
                        {errors.yearsOfResidence && <p className="text-xs text-destructive">{errors.yearsOfResidence.message}</p>}
                    </div>
                    ...
                    <div className="space-y-1.5">
                        ...
                        />
                        {errors.streetName && <p className="text-xs text-destructive">{errors.streetName.message}</p>}
                    </div>
