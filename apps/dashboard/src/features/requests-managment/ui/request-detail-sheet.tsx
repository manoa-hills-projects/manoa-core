...
import type { DocumentRequest, ResidencyLetterPayload } from "@/entities/requests";
import {
    Sheet,
    SheetContent,
    SheetHeader,
...
export function RequestDetailSheet({ request, open, onClose }: RequestDetailSheetProps) {
    ...
    const { mutateAsync: reviewRequest, isPending: isReviewing } = useReviewRequest(
        request?.id ?? ""
    );
            ...
            <SheetContent className="overflow-y-auto w-full sm:max-w-lg">
                ...
                <div className="mt-6 space-y-4 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className={cn("inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold", statusClass)}>
                    ...
                    <div className="rounded-lg border bg-muted/30 p-4 space-y-2">
                        ...
                        {[
                            ...
                            ["Fecha de emisión", `${payload.issueDay} de ${payload.issueMonth} del 2025`],
                        ].map(([label, value]) => (
