...
import { type Family, useFamilies } from "@/entities/families";
...
export function HouseDetailSheet({
	...
	const { data: response } = useFamilies(pagination, { house_id: house?.id });
	...
	return (
		<Sheet open={open} onOpenChange={onOpenChange}>
			<SheetContent
				side="right"
				showCloseButton
				className="sm:max-w-xl outline-none overflow-y-auto"
			>
				<SheetHeader>
