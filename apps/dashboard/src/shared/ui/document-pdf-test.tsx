...
export const DocumentPdfTest = ({ citizenName, documentId, qrImageBase64 }: DocumentPdfTestProps) => (
  <Document>
    <Page size="A4" style={styles.page}>
      <Text style={styles.title}>Certificado Oficial de Manoa</Text>
      
      <Text style={styles.body}>
        Por medio del presente documento se hace constar que el ciudadano {citizenName} 
        ha sido registrado satisfactoriamente en los censos oficiales. 
        Este documento sirve como comprobante de inscripción y posee un código 
        QR en la parte inferior para validar su total autenticidad desde 
        nuestra plataforma oficial.
      </Text>

      <View style={styles.signatureSection}>
        <View>
          <Text style={styles.signatureText}>Firma Autorizada</Text>
          <Text style={styles.signatureText}>Sistema Core (ID: {documentId.split('-')[0]})</Text>
        </View>
        ...
        <View style={styles.qrContainer}>
          {qrImageBase64 ? (
            ...
            <Text style={{ fontSize: 8, textAlign: 'center' }}>QR{'\n'}Code</Text>
          )}
        </View>
      </View>
    </Page>
